...
title: 从里程碑迁移到自定义链接
uuid: 1c8edde5-0ef1-4bc0bc0-a62 d-1747f09
...
视频测量的核心概念与里程碑和自定义链接跟踪的核心概念相同，即获取视频播放器事件并将其映射到分析方法，同时还获取播放器元数据和值并将其映射到分析变量。应将“自定义链接”方法视为对实施和所收集数据的精简和简化。使用“自定义链接”解决方案，不会为视频测量预定义任何变量或方法，它需要进行完整的自定义设置。应当可以更新播放器事件代码，以指向基本的播放器事件（例如开始和结束）的自定义链接跟踪调用。有关更多详细信息，请参阅[自定义链接实施指南](../../measurement-options/cl-in-aa/cl-impl-guide.md)和[使用自定义链接代码手动链接跟踪](https://marketing.adobe.com/resources/help/en_US/sc/implement/link_manual.html)。
...
“event2”，“a
 media. complete”：
“event7”，“a
 media. milestiles”：{25：“event4”，50：“event5”，75：“event6”}}；
</pre>
</td>
<td>不适用
</td>
...
s. Media. contextDataMapping={“a.
 ...
 media. media. segment”：“eVar3”、“a.
 contentType”：“eVar1”、“a
 media. media Timed”：“event3”，“a.
 media. view”：“event1”，“a
...
<td>
<pre>
s. contextData['video. player']=”customPlayer名称”；
</pre>
</td>
</tr>
<tr>
...
<tr>
<td>mediaName</td>
<td><b>MediaName：</b> (必需)您希望视频在视频报表中显示的名称。</td>
...
<td>
<b>mediaPlayerName：</b> (必需)用于在视频报表中显示视频时用于观看视频的媒体播放器的名称。
</td>
<td>
在链接调用中设置 eVar 或上下文数据变量
</td>
...
<td>
<b>playerName：</b> (必需)用于查看广告的媒体播放器的名称。
</td>
<td>不适用
</td>
<td>不可用
