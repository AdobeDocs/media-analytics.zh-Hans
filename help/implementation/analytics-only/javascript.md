...
* **先决条件**：
   ...
   * 实施[AppMeasurement](https://experienceleague.adobe.com/zh-hans/docs/analytics/implementation/js/overview)和[访客ID服务](https://experienceleague.adobe.com/zh-hans/docs/analytics/implementation/id/appmeasurement)。
