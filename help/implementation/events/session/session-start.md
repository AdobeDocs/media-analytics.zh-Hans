...
在恢复之前关闭的会话时（例如，跨设备切换后或应用程序恢复保存的播放状态后），在会话开始时设置恢复标志。 这会导致Analytics递增[[!UICONTROL 内容恢复]](/help/reporting/metrics/content-resumes.md)，而不是[[!UICONTROL 媒体开始]](/help/reporting/metrics/media-starts.md)。
