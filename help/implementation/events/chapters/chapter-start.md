...
使用`adb_media_init_chapterinfo`生成章节对象，然后跟踪该事件：
...
向[事件终结点](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/events)发送`chapterStart`帖子：
