...
使用`MEDIA_AD_COMPLETE`事件类型调用`mediaTrackEvent`：
...
向[事件终结点](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/events)发送`adComplete`帖子：
