...
>[!MORELIKETHIS]
>* [自定义元数据支持 — XDM格式](/help/implementation/edge/custom-metadata.md)
>* 报告包数据的[Adobe Analytics源连接器](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/sources/connectors/adobe-applications/analytics)
