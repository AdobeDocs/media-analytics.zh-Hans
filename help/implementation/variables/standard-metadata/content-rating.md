...
| **XDM集合字段** | [`xdm.mediaCollection.sessionDetails.rating`](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/data-types/session-details-collection) |
...
在调用`mediaTrackSessionStart`之前，使用`MEDIA_VideoMetadataKeyRATING`在媒体对象的标准元数据中设置内容分级：
