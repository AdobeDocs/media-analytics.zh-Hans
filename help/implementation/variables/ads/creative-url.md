...
| **XDM集合字段** | [`xdm.mediaCollection.advertisingDetails.creativeURL`](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/xdm/data-types/advertising-details-collection) |
...
调用[`sendEvent`](https://experienceleague.adobe.com/cn/docs/experience-platform/collection/js/commands/sendevent/overview)时，在`xdm.mediaCollection.advertisingDetails`中设置`creativeURL`：
...
为`media.adStart`调用`sendMediaEvent`时，在`xdm.mediaCollection.advertisingDetails`中设置`creativeURL`：
...
调用`xdm.mediaCollection.advertisingDetails`中包含`creativeURL`的[adStart](https://developer.adobe.com/data-collection-apis/docs/endpoints/media/ads/#adstart)终结点：
...
使用标准广告元数据对象中的`ADBMobile.media.AdMetadataKeys.CREATIVE_URL`设置创意URL：
...
使用标准广告元数据对象中的`MEDIA_AdMetadataKeyCREATIVE_URL`设置创意URL：
