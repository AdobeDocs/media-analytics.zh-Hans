...
1. 2021 年 8 月 31 日之后，将不再支持 Mobile v4 SDK。您应该迁移到适用于 iOS 和 Android 的 Adobe Experience Platform (AEP) SDK。
...
1. **是否需要将 Launch 作为标签管理系统？如果我不想使用 Launch，应该怎么办？**
   ...
   对于移动设备，需要使用 Launch 来配置媒体扩展，例如 Mobile Services UI。在移动设备应用程序用例中，它不用作标签管理系统。
