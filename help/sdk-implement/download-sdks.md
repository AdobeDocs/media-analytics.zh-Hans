...
| MA 启动组件   | 文档 | 示例 |
|---|---|---|
| **Web 扩展** | [Adobe Media Analytics for Audio and Video 扩展](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html?lang=zh-Hans) | [Adobe Media Analytics for Audio and Video 扩展](https://github.com/Adobe-Marketing-Cloud/media-sdks/tree/master/samples/launch/js/2.x) |
