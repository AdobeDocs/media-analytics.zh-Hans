...
|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置</li> <li> **API 密钥：**<br/>&#x200B;不适用</li> <li> **类型：**<br/>&#x200B;字符串</li> <li> **发送条件：**<br/>&#x200B;媒体开始</li> <li> **最低 SDK 版本：**&#x200B;任何版本</li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;媒体的载入事件。（当查看者单击&#x200B;_播放_&#x200B;按钮时，会发生此事件。）即使存在前置广告、缓冲和错误等，也会将此计为视频载入事件。<br/>**重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。<br/> **发行日期：2018 年 9 月 13 日** </li></ul> | <ul> <li> **Adobe Analytics：**<br/>(a.media.view) </li> <li> **心率：**<br/> (s):event:<br/>type=start) </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;媒体开始 </li> <li> **上下文数据：**<br/>(a.media.view) </li> <li> **数据馈送：**<br/> videostart </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.view) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.starts.value， media.mediaTimed.dropBeforeStart.value </li> </ul> |

### 内容开始

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;第一帧媒体内容已观看。如果用户在广告播放或缓冲等过程中放弃观看，则不会计为“内容开始”事件。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;内容开始 </li> <li> **上下文数据：**<br/>(a.media.play) </li> <li> **数据馈送：**<br/> videoplay </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.play) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.dropBeforeStart.value </li> </ul> |

### 内容结束 {#content-complete}

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;已观看至结束的流。这不一定意味着用户观看或收听了整个流；他们可以跳到前面。此参数仅意味着用户百分百到达流结尾。<br/>另请参阅[会话结束](quality-parameters.md#session-end)<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/> (s):event:<br/>type=complete) </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;内容结束 </li> <li> **上下文数据：**<br/>(a.media.complete) </li> <li> **数据馈送：**<br/> videocomplete   </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.complete) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.completes.value </li> </ul> |

### 内容逗留时间

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 105 </li> <li> **描述：**<br/>&#x200B;计算主内容中所有“播放”类型事件的事件总时长（以秒为单位）。值将以时间格式(HH)显示:MM:SS)。 而在数据馈送、Data Warehouse 和报表 API 中，该值将以秒数显示。<br/> **发行日期：2018 年 9 月 13 日** </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;内容逗留时间 </li> <li> **上下文数据：**<br/>(a.media.timePlayed) </li> <li> **数据馈送：**<br/> videotime </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.timePlayed) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.dropBeforeStart.value </li> </ul> |

### 平均逗留时间

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 120 </li> <li> **描述：**<br/>&#x200B;计算主要内容和广告内容中所有“播放”类型事件的事件总时长（以秒为单位）。值将以时间格式(HH)显示:MM:SS)。 而在数据馈送、Data Warehouse 和报表 API 中，该值将以秒数显示。<br/> **发行日期：2018 年 9 月 13 日** </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;媒体逗留时间 </li> <li> **上下文数据：**<br/>(a.media.totalTimePlayed) </li> <li> **数据馈送：**<br/> videototaltime </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.totalTimePlayed) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.totalTimePlayed.value </li> </ul> |

### 不重复播放时间

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 94 </li> <li> **描述：**<br/>&#x200B;会话期间不重复播放的内容区段的时间值（以秒为单位）。不包含向回搜寻观看的情况（查看者多次观看同一内容区段）所播放的时间。值将以时间格式(HH)显示:MM:SS)。 而在数据馈送、Data Warehouse 和报表 API 中，该值将以秒数显示。<br/> **发行日期：2018 年 9 月 13 日** </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/> 独特播放时间 </li> <li> **上下文数据：**<br/>(a.media.uniqueTimePlayed) </li> <li> **数据馈送：**<br/> videouniquetimeplayed </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.uniqueTimePlayed) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.uniqueTimePlayed.value </li> </ul> |

### 10% 进度标记

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;根据内容时长，播放头经过内容的 10% 进度标记。即使向后搜索，标记也只会计数一次。如果向前搜索，则不计数跳过的标记。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/> 10% 进度标记 </li> <li> **上下文数据：**<br/>(a.media.progress10) </li> <li> **数据馈送：**<br/> videoprogress10 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.progress10) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.progress10.value </li> </ul> |

### 25% 进度标记

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;根据内容时长，播放头经过内容的 25% 进度标记。即使向后搜索，标记也只会计数一次。如果向前搜索，则不计数跳过的标记。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/> 25% 进度标记 </li> <li> **上下文数据：**<br/>(a.media.progress25) </li> <li> **数据馈送：**<br/> videoprogress25 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.progress25) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.progress25.value </li> </ul> |

### 50% 进度标记

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;根据内容时长，播放头经过内容的 50% 进度标记。即使向后搜索，标记也只会计数一次。如果向前搜索，则不计数跳过的标记。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/> 50% 进度标记 </li> <li> **上下文数据：**<br/>(a.media.progress50) </li> <li> **数据馈送：**<br/> videoprogress50 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.progress50) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.progress50.value </li> </ul> |

### 75% 进度标记

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/> **不适用** </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;根据内容时长，播放头经过内容的 75% 进度标记。即使向后搜索，标记也只会计数一次。如果向前搜索，则不计数跳过的标记。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/> 75% 进度标记 </li> <li> **上下文数据：**<br/>(a.media.progress75) </li> <li> **数据馈送：**<br/> videoprogress75 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.progress75) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.progress75.value </li> </ul> |

### 95% 进度标记

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;根据内容时长，播放头经过内容的 95% 进度标记。即使向后搜索，标记也只会计数一次。如果向前搜索，则不计数跳过的标记。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/> 95% 进度标记 </li> <li> **上下文数据：**<br/>(a.media.progress95) </li> <li> **数据馈送：**<br/> videoprogress95 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.progress95) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.progress95.value </li> </ul> |

### 平均观看分钟数

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/>&#x200B;大于或等于 1 </li> <li> **描述：**<br/>“平均观看分钟数”量度的计算方式为一个特定媒体项目的内容逗留总时间除以该媒体项目所有播放会话的时长：<br/><br/> `average_minute_audience = timeSpent / videoLength;` </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;平均观看分钟数 </li> <li> **上下文数据：**<br/>(a.media.averageMinuteAudience) </li> <li> **数据馈送：**<br/> videoaverageminuteaudience </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.averageMinuteAudience) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.averageMinuteAudience.value </li> </ul> |

### 自上次调用以后经过的秒数

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 600</li> <li> **说明：**<br/>&#x200B;如果流在关闭时带有完整事件或结束事件，则自上次调用量度开始的秒数为 0；如果由于超时而关闭，则通常为 600。此量度没有解决方案变量和自动处理规则，因此您必须创建自定义处理规则才能进行保存。</li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;使用自定义处理规则 </li> <li> **保留的变量：**<br/>&#x200B;不适用 </li> <li> **报表名称：**<br/>&#x200B;自定义</li> <li> **上下文数据：**<br/>(a.media.secondsSinceLastCall) </li> <li> **数据馈送：**<br/> videosecondssincelastcall </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.secondsSinceLastCall) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.primaryAssetViewDetails.sessionTimeout </li> </ul> |

### 联合数据

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;布尔值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> true  </li> <li> **描述：**<br/>&#x200B;如果点击已联合（即，客户作为联合数据共享的一部分接收，而不是他们自己的实施），则设置为 true。 </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;使用自定义处理规则 </li> <li> **保留的变量：**<br/>&#x200B;不适用 </li> <li> **报表名称：**<br/>&#x200B;不适用 </li> <li> **上下文数据：**<br/>(a.media.federated) </li> <li> **数据馈送：**<br/>&#x200B;不适用 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.federated) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.federated.value </li> </ul> |

### 预计的流

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 1 - 播放 19 分钟；<br/>2 - 播放 31 分钟；<br/>3 - 播放 78 分钟。 </li> <li> **描述：**<br/>&#x200B;每个内容的预计视频流或音频流数量。播放时间（内容 + 广告）每增加 30 分钟，该值也会相应增加。客户必须自行创建处理规则才能在报表中使用此值。<br/><br/>会将每 30 分钟计为一个流，此计算基于 `ms_s`（或 totalTimePlayed = Video Total Time），类似于：<br/> `estimatedStreams = ` <br/>   `FLOOR(ms_s/1800) + 1` </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;使用自定义处理规则 </li> <li> **保留的变量：**<br/>&#x200B;不适用 </li> <li> **报表名称：**<br/>&#x200B;自定义 </li> <li> **上下文数据：**<br/>(a.media.estimatedStreams) </li> <li> **数据馈送：**<br/>&#x200B;不适用 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.estimatedStreams) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.estimatedStreams.value </li> </ul> |

### 受暂停影响的流

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：** 1.5.6 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;此值为 true 或 false。如果在播放单个媒体项目期间发生了一次或多次暂停，则值为 true。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/> (s):event:<br/>type=pause) </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;受暂停影响的流 </li> <li> **上下文数据：**<br/>(a.media.pause) </li> <li> **数据馈送：**<br/> videopause </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.pause) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.pauseImpectedStreams.value > 0 => &quot;TRUE&quot; </li> </ul> |

### 暂停事件

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：** 1.5.6 </li> <li> **示例值：**<br/> 2 </li> <li> **描述：**<br/>&#x200B;此量度计算为在播放会话期间发生暂停时段的次数。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/> (s):event:<br/>type=pause) </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;暂停事件 </li> <li> **上下文数据：**<br/>(a.media.pauseCount) </li> <li> **数据馈送：**<br/> videopausecount </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.pauseCount) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.pauntes.value </li> </ul> |

### 暂停总持续时间

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：** 1.5.6 </li> <li> **示例值：**<br/> 190 </li> <li> **描述：**<br/>&#x200B;计算所有“暂停”类型事件的时长总和（以秒为单位）。值将以时间格式(HH)显示:MM:SS)。 而在数据馈送、Data Warehouse 和报表 API 中，该值将以秒数显示。<br/> **发行日期：2018 年 9 月 13 日** </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;暂停总持续时间 </li> <li> **上下文数据：**<br/>(a.media.pauseTime) </li> <li> **数据馈送：**<br/> (videopausetime) </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.pauseTime) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.pauseTime.value </li> </ul> |

### 内容继续

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/> **media.resume** </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：** 1.5.6 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;每次在超过 30 分钟的缓冲、暂停或停止时段后继续播放，即计为继续一次，或者此值由播放器在 VideoInfo trackPlay 中进行设置。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/> (s):event:<br/>type=resume) </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;内容继续 </li> <li> **上下文数据：**<br/>(a.media.resume) </li> <li> **数据馈送：**<br/> videoresume </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.resume) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.rescoveres.value > 0 => &quot;TRUE&quot; </li> </ul> |

### 内容区段查看

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;主内容的查看次数。在查看了至少一个帧时，即计为内容区段查看一次。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。 </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;内容区段查看 </li> <li> **上下文数据：**<br/>(a.media.segmentView) </li> <li> **数据馈送：**<br/> videosegmentviews </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.segmentView) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.mediaSegmentViews.value > 0 => &quot;TRUE&quot; </li> </ul> |
...
|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;不适用 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 2 </li> <li> **描述：**<br/> 在媒体会话期间启动的广告数。   <br/> </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;使用自定义处理规则 </li> <li> **保留的变量：**<br/>&#x200B;不适用 </li> <li> **报表名称：**<br/>&#x200B;自定义 </li> <li> **上下文数据：**<br/> (a.media.adCount) </li> <li> **数据馈送：**<br/>&#x200B;不适用 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.adCount) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.adCount.value </li> </ul> |

### 章节计数

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;不适用 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 2 </li> <li> **描述：**<br/> 在媒体会话期间开始的章节数。   <br/> </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;使用自定义处理规则 </li> <li> **保留的变量：**<br/>&#x200B;不适用 </li> <li> **报表名称：**<br/>&#x200B;自定义 </li> <li> **上下文数据：**<br/> (a.media.chapterCount) </li> <li> **数据馈送：**<br/>&#x200B;不适用 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.chapterCount) </li> <li> **XDM字段路径：**<br/> media.mediaTimed.chapterCount.value </li> </ul> |
