...
|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;已观看至结束的流。这不一定意味着用户观看或收听了整个流；他们可以跳到前面。此参数仅意味着用户百分百到达流结尾。<br/>另请参阅[会话结束](quality-parameters.md#session-end)<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>(s:event:<br/>type=complete) </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;内容结束 </li> <li> **上下文数据：**<br/>(a.media.complete) </li> <li> **数据馈送：**<br/> videocomplete   </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.complete) </li> <li> **XDM 字段路径：**<br/> media.mediaTimed.completes.value </li> </ul> |
...
|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 120 </li> <li> **描述：**<br/>&#x200B;计算主要内容和广告内容中所有“播放”类型事件的事件总时长（以秒为单位）。该值将在 Analysis Workspace 和 Reports &amp; Analytics 中以时间格式 (HH:MM:SS) 显示。而在数据馈送、Data Warehouse 和报表 API 中，该值将以秒数显示。<br/> **发行日期：2018 年 9 月 13 日** </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;媒体逗留时间 </li> <li> **上下文数据：**<br/>(a.media.totalTimePlayed) </li> <li> **数据馈送：**<br/> videototaltime </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.totalTimePlayed) </li> <li> **XDM 字段路径：**<br/> media.mediaTimed.totalTimePlayed.value </li> </ul> |

### 不重复播放时间

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 94 </li> <li> **描述：**<br/>&#x200B;会话期间不重复播放的内容区段的时间值（以秒为单位）。不包含向回搜寻观看的情况（查看者多次观看同一内容区段）所播放的时间。该值将在 Analysis Workspace 和 Reports &amp; Analytics 中以时间格式 (HH:MM:SS) 显示。而在数据馈送、Data Warehouse 和报表 API 中，该值将以秒数显示。<br/> **发行日期：2018 年 9 月 13 日** </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/>&#x200B;唯一的播放时间 </li> <li> **上下文数据：**<br/>(a.media.uniqueTimePlayed) </li> <li> **数据馈送：**<br/> videouniquetimeplayed </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.uniqueTimePlayed) </li> <li> **XDM 字段路径：**<br/> media.mediaTimed.uniqueTimePlayed.value </li> </ul> |

### 10% 进度标记

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;自动设置 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;字符串 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> TRUE </li> <li> **描述：**<br/>&#x200B;根据内容时长，播放头经过内容的 10% 进度标记。即使向后搜索，标记也只会计数一次。如果向前搜索，则不计数跳过的标记。<br/> **重要信息：**&#x200B;如果设置此参数，只能将其设置为 true。如果不设置此参数，则不会返回任何值。  </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;是 </li> <li> **保留的变量：**<br/> event </li> <li> **报表名称：**<br/> 10% 进度标记 </li> <li> **上下文数据：**<br/>(a.media.progress10) </li> <li> **数据馈送：**<br/> videoprogress10 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.progress10) </li> <li> **XDM 字段路径：**<br/> media.mediaTimed.progress10.value </li> </ul> |
...
|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;不适用 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 2 </li> <li> **描述：**<br/>&#x200B;在媒体会话期间启动的广告数量。<br/> </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;使用自定义处理规则 </li> <li> **保留的变量：**<br/>&#x200B;不适用 </li> <li> **报表名称：**<br/>&#x200B;自定义 </li> <li> **上下文数据：**<br/>(a.media.adCount) </li> <li> **数据馈送：**<br/>&#x200B;不适用 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.adCount) </li> <li> **XDM 字段路径：**<br/> media.mediaTimed.adCount.value </li> </ul> |

### 章节计数

|   实施   | 网络参数 | 报表 |
| --- | --- | --- |
| <ul> <li> **SDK 密钥：**<br/>&#x200B;不适用 </li> <li> **API 密钥：**<br/>&#x200B;不适用 </li> <li> **类型：**<br/>&#x200B;数值 </li> <li> **发送条件：**<br/>&#x200B;媒体关闭 </li> <li> **最低 SDK 版本：**&#x200B;任何版本 </li> <li> **示例值：**<br/> 2 </li> <li> **描述：**<br/>&#x200B;在媒体会话期间启动的章节数量。<br/> </li></ul> | <ul> <li> **Adobe Analytics：**<br/>&#x200B;不适用 </li> <li> **心率：**<br/>&#x200B;不适用 </li> </ul> | <ul> <li> **可用：**<br/>&#x200B;使用自定义处理规则 </li> <li> **保留的变量：**<br/>&#x200B;不适用 </li> <li> **报表名称：**<br/>&#x200B;自定义 </li> <li> **上下文数据：**<br/>(a.media.chapterCount) </li> <li> **数据馈送：**<br/>&#x200B;不适用 </li> <li> **Audience Manager：**<br/>(c_contextdata.<br/>a.media.chapterCount) </li> <li> **XDM 字段路径：**<br/> media.mediaTimed.chapterCount.value </li> </ul> |
