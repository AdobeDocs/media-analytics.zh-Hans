...
>[!MORELIKETHIS]
>
>* [会话开始](/help/implementation/events/session/session-start.md)
>* [播放](/help/implementation/events/playback/play.md)
>* [暂停开始](/help/implementation/events/playback/pause-start.md)
>* [缓冲开始](/help/implementation/events/playback/buffer-start.md)
>* [会话完成](/help/implementation/events/session/session-complete.md)
>* [会话结束](/help/implementation/events/session/session-end.md)
