---
title: 了解支持的设备和平台
description: “了解流媒体收集加载项支持的主要设备，例如iOS、Android、OTT设备和JavaScript浏览器。”
...
对于当前不支持 SDK 的设备，或者在您可能需要自定义实施的情况下，您可以使用媒体收集 API 或 Media Edge API。这些API允许您直接从设备对流媒体收集加载项后端进行RESTful API调用。
