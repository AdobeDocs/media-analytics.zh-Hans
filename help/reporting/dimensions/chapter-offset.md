...
播放器在每个[章节开始](/help/implementation/events/chapters/chapter-start.md)事件时设置章节偏移。
...
| Customer Journey Analytics | [`xdm.mediaReporting.chapterDetails.offset`](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/xdm/data-types/chapter-details-reporting) |
...
为报表包启用了&#x200B;**[[!UICONTROL 媒体章节]](/help/reporting/setup/analytics-reporting.md)**&#x200B;时，Adobe会自动创建章节偏移分类结构。 您负责使用[分类集](https://experienceleague.adobe.com/en/docs/analytics/components/classifications/sets/overview.html)填充和维护分类。
...
每个项目都是在[章节开始](/help/implementation/events/chapters/chapter-start.md)时报告的整数偏移值（以秒为单位）。
