...
播放器在每`media.chapterStart`个事件中设置章节位置。
...
| Customer Journey Analytics | [`mediaReporting.chapterDetails.index`](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/xdm/data-types/chapter-details-reporting) |
...
每个项目是`media.chapterStart`上报告的整数位置值。
