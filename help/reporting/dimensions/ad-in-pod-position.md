...
Pod中的广告位置由播放器在每个`media.adStart`事件中设置。

| 报告系统 | 来源 |
| --- | --- |
| Adobe Analytics | 启用[[!UICONTROL 媒体广告]](/help/reporting/media-reports-enable.md)时，从上下文数据`a.media.ad.podPosition`自动收集。 |
| Customer Journey Analytics | [`mediaReporting.advertisingDetails.podPosition`](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/xdm/data-types/advertising-details-reporting) |
| 数据馈送 | `videoadinpod, post_videoadinpod` |

## 维度项目

每个项目都是整数值位置值(`0`、`1`、`2`、...) 已于`media.adStart`报告。
