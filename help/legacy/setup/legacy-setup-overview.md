...
有关跟踪服务器选项的更多信息，请参阅[正确填充trackingServer和trackingServerSecure变量。](https://helpx.adobe.com/analytics/kb/determining-data-center.html)
...
* [Primetime用户指南](https://helpx.adobe.com/cn/primetime/user-guide.html)
