...
如果 Media Analytics 是您的预期路径，请参阅 [Media SDK 实施](/help/implementation/media-sdk/media-sdk-overview.md)和[媒体收集 API](/help/implementation/media-collection-api/mc-api-overview.md)。
